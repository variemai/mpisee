...
extern "C" void mpisee_init_fortran_mpi_status_ignore_(
    MPI_Fint *status_ignore) {
    mpisee_fortran_mpi_status_ignore = status_ignore;
}

extern "C" void mpisee_init_fortran_mpi_statuses_ignore_(
    MPI_Fint *statuses_ignore) {
